...
static VALUE packcr_context_parse(VALUE self, VALUE rflag) {
    return parse(self, RB_TEST(rflag) ? TRUE : FALSE);
}
...
void Init_packcr(void) {
    ...
    rb_define_method(cPackcr_Context, "_parse", packcr_context_parse, 1);
