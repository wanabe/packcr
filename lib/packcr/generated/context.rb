  ...
  class Context
    ...
    def get_source_code(lang, stream)
      ...
      when :c
        ...
        erbout << "    pcc_lr_memo_t *memo = pcc_lr_table__get_memo(ctx, &ctx->lrtable, offset, rule);\n\n    if (memo == NULL) {\n        memo = pcc_lr_memo__create(ctx, offset".freeze

        if @location
          erbout << ", offset_loc".freeze
        end
        erbout << ");\n        pcc_lr_table__set_memo(ctx, &ctx->lrtable, offset, rule, memo);\n        c = rule(ctx, offset".freeze
